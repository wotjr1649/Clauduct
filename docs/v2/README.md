...
## 1. 현재 상태 (2026-09-25, v0.4.1 출시·v0.4.2 개발 검증 완료)

| 항목 | 값 |
|---|---|
| 최신 출시 | **v0.4.1** (태그 `v0.4.1` → `4f56f94`). 변경과 출하 검사는 [RELEASE-v0.4.1.md](RELEASE-v0.4.1.md). 그 전은 [v0.4.0](RELEASE-v0.4.0.md) |
...
| 측정된 클라이언트 | claude **2.1.282**(기준 상수·인자 표·native fixture, v0.4.2 재측정. 실제 backend TUI·SDK는 v0.4.2 개발본에서 통과). Codex CLI 기준은 0.156.1(v0.4.1 재측정: 설치본 요청과의 차이를 기록하고 이 빌드의 요청 모양은 유지, #121), 설치본은 계속 바뀐다. 이전 기준은 2.1.281. Windows, go 1.27.1 |
...
v0.4.2의 메모리 수용 제어는 개발 검증을 마쳤다. [릴리스 노트 초안](RELEASE-v0.4.2.md)은 출하 전 기록이다.
