...
export async function readRequestStatus(env) {
  ...
  return { clientContextPolicy: { evidence: 'inherited-environment',
    ...
    selectionSource: ['explicit-metadata', 'role-default', 'native-inherit', 'skill-result', 'verified-resume', 'native-fork'].includes(row?.selectionSource) ? row.selectionSource : null,
