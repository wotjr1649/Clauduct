...
$paths = @('clauduct.cmd', 'RELEASE.md', 'docs/claude-option-classification.md', 'src',
    ...
    'verification/fixtures/development-mcp.mjs', 'verification/fixtures/development-oracle.mjs', 'verification/fixtures/development-window-oracle.mjs', 'verification/fixtures/development-integration-oracle.mjs', 'verification/fixtures/development-project-oracle.mjs',
