...
// a terminal can run the interactive TUI evidence checks. Standard library only.
//
//	go run ptydrive.go -dir <cwd> -script steps.json -log raw.log -text screen.txt -env K=V ... -- <exe> <args...>
package main
