...
export const FAILURE_DIAGNOSTIC_CATEGORIES = Object.freeze([
  ...
  'UPSTREAM_DNS_ERROR', 'UPSTREAM_TLS_ERROR', 'UPSTREAM_ACCESS_DENIED',
  ...
  'VERIFICATION_CONNECTION_FAULT_REJECTED',
  'ATTEMPT_OBSERVER_FAILED', 'RESPONSE_OBSERVER_FAILED', 'VERIFICATION_LEDGER_INVALID', 'VERIFICATION_LEDGER_IO', 'VERIFICATION_PROGRESS_FAILED',
  'REQUEST_BUDGET',
  ...
  'INVALID_AGENT_BINDING', 'AGENT_BINDING_CONFLICT', 'AGENT_BINDING_LIMIT',
  'OTHER'
]);
